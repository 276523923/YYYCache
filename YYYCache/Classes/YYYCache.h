...
@interface YYYCache : NSObject

/** The name of the cache, readonly. */
@property (copy, readonly) NSString *name;

/** The underlying memory cache. see `YYYMemoryCache` for more information.*/
@property (strong, readonly) YYYMemoryCache *memoryCache;

/** The underlying disk cache. see `YYYDiskCache` for more information.*/
@property (strong, readonly) YYYDiskCache *diskCache;
