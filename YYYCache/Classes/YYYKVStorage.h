 ...
 */
@interface YYYKVStorageItem : NSObject
...
@property (nonatomic) int expirationTime;                   ///< expiration  unix timestamp
 ...
 * If you want to store large number of small datas (such as contacts cache),
 use YYYKVStorageTypeSQLite to get better performance.
 * If you want to store large files (such as image cache),
 use YYYKVStorageTypeFile to get better performance.
 * You can use YYYKVStorageTypeMixed and choice your storage type for each item.
 
 See <http://www.sqlite.org/intern-v-extern-blob.html> for more information.
 */
typedef NS_ENUM(NSUInteger, YYYKVStorageType) {

    /// The `value` is stored as a file in file system.
        YYYKVStorageTypeFile = 0,

    /// The `value` is stored in sqlite with blob type.
        YYYKVStorageTypeSQLite = 1,

    /// The `value` is stored in file system or sqlite based on your choice.
        YYYKVStorageTypeMixed = 2,
};
 ...
 */
@interface YYYKVStorage : NSObject
...
@property (nonatomic, readonly) YYYKVStorageType type;  ///< The type of this storage.
 ...
 */
- (nullable instancetype)initWithPath:(NSString *)path type:(YYYKVStorageType)type NS_DESIGNATED_INITIALIZER;
 ...
 */
- (nullable YYYKVStorageItem *)getItemForKey:(NSString *)key;
 ...
 */
- (nullable YYYKVStorageItem *)getItemInfoForKey:(NSString *)key;
 ...
 */
- (nullable NSArray<YYYKVStorageItem *> *)getItemForKeys:(NSArray<NSString *> *)keys;
...
/**
 ...
 @return An array of `YYKVStorageItem`, or nil if not exists / error occurs.
 */
- (nullable NSArray<YYYKVStorageItem *> *)getItemInfoForKeys:(NSArray<NSString *> *)keys;
